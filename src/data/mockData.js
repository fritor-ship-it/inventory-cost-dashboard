...
export const AI_COMMENTARY = {
  month: '2025-12',
  costRateAlert: true,
  summary: '2025년 12월 재료비 원가율이 전월 대비 소폭 상승하였습니다. Henry Schein B2B 임상진단 시약 20종(HS-001~020) 및 씨젠 STI B2C 시약 20종(SG-001~020) 포함 전체 252개 SKU 기준 분석되었습니다. Henry Schein Troponin 단가 급등(+21.1%)과 씨젠 Allplex™ STI/HPV 계열 검사 수요 증가가 12월 원가율 상승의 주요 원인입니다.',
  keyFindings: [
